...
Scenario: Get List of users details and verify basic details
    Given call read('classpath:features/apitests/reqres/testHelper/ReqResGetHelper.feature@name=GetListOfUsers')
...
Scenario: Get single user details and verify the details
    Given call read('classpath:features/apitests/reqres/testHelper/ReqResGetHelper.feature@name=GetSingleUserDetails')
