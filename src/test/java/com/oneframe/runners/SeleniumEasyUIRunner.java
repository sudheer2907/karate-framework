...
public final class SeleniumEasyUIRunner {
  ...
  public void runOneFeatureFile() {
    ...
    Results results =
        Runner.path("classpath:features/uitests/seleniumeast/testFeatures/TestReqResPost.feature")
  ...
  public void runMultipleFeatureFiles() {
    ...
    Results results = Runner.builder().outputCucumberJson(true)
        .path("classpath:features/uitests/seleniumeast/testFeatures").tags("~@Ignore").parallel(2);
    Assertions.assertEquals(0, results.getFailCount());
    generateReport(results.getReportDir());
  }
  ...
  public static void generateReport(String karateOutputPath) {
    ...
    Configuration config = new Configuration(new File("target"), "Selenium Easy");
